...
* Thirdly, we looked at the fly mRNA sequence in the conservation track from the input region and saw that there are several other copies of it in the mouse genome, five of which are identical to the NM_001014551 gene in the fly. We doubt that it is likely for a gene to have 5 identical and functional copies in a genome. Furthermore, our input region appears to be the complete last exon of the annotated rlp41 gene and part of the intronic region as well (FIGURE). It is more likely that these are remnants of an original gene that was once retrotransposed and then duplicated many times generating many copies in the genome, 5 of which seem to be identical. If these copies are pseudogenes derived by the retrotransposition of the original pseudogene in a specific region in the genome, one would often expect them to have acquired mutations, but it could be that the 5 copies were retrotransposed relatively recently and have not mutated enough.  
